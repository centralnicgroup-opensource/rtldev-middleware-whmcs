...
$additionaldomainfields[".xxx"][] = [
    "Name" => "Agreement",
    "Type" => "tickbox",
    "Description" => "Tick to confirm that you agree to the <a href=\"http://www.icmregistry.com/about/policies/registry-registrant-agreement/
\" target=\"_blank\">Registry Terms and Conditions of Registration</a> upon new registration of .XXX domain names.",
    "Required" => true,
...
$additionaldomainfields[".xxx"][] = [
    ...
    "Options" => "0|Resolving,1|Non-Resolving",
    "Default" => "0",
    "Required" => false
];
$additionaldomainfields[".xxx"][] = [
