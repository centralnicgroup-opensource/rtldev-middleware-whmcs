...
if (isset($tac[$tld])) {
    $cfg["Description"] = "<div>I certify that the Registrant is eligibile to register this domain and that all provided information is true and accurate. Eligibility criteria may be viewed <a href='" . $tac[$tld] . "' target='_blank'>here</a>.</div>";
} elseif ($tld == ".eco") {
    $cfg["Description"] = "<div>All .ECO domain names will be first registered with \"server hold\" status pending the completion of the minimum requirements of the Eco Profile, namely, the .ECO registrant 1) affirming their compliance with the .ECO Eligibility Policy and 2) pledging to support positive change for the planet and to be honest when sharing information on their environmental actions. The registrant will be emailed with instructions on how to create an Eco Profile. Once these steps have been completed, the .ECO domain will be immediately activated by the registry.</div>";
} else {
    $cfg["Description"] = "<div style='padding:10px 0px'><b>Safeguards for Highly-regulated TLDs</b><br/>
