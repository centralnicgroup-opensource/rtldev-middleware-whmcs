...
$_LANG["hxflagstacregulateddescrgoogle"] = (
    "أنت تقر بأن {TLD} عبارة عن مساحة اسم آمنة ، مما يعني أن أسماء نطاقات {TLD} تتطلب شهادة SSL للعمل. لا يمكن الوصول إلى مواقع الويب التي تستخدم اسم نطاق {TLD} إلا عن طريق متصفحات الويب باستخدام HTTPS من خلال اتصال مشفر وآمن."
);
...
$_LANG["hxdomaincontactstradeinfo"] = (
    "قد تؤدي تغييرات بيانات جهة اتصال المسجل إلى ما يسمى بعملية \"Trade\"" .
